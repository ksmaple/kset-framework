...
> 本文件是 Claude 薄索引。完整 AI 协作配置以 [.claude/AGENTS.md](.claude/AGENTS.md) 为单源真相。
...
- Claude 直接读取 `.claude/skills/`。
- Codex / Cursor 分别通过 `.agents/skills/`、`.cursor/skills/` 链接到 `.claude/skills/`。
