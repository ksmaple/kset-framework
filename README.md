...
```
kset-framework/
├── kset-parent/              # 版本 BOM（Boot 3.5.14 / SC 2025.0.2 / SCA 2025.0.0.0 / Dubbo 3.3.6）
...
| 文档 | 说明 |
|------|------|
| [kset-parent/README.md](kset-parent/README.md) | Java 21、Spring Boot / Cloud / Alibaba / Dubbo 版本基线与发布 |
...
Spring 生态版本以 `kset-parent/pom.xml` 为准：Spring Boot 3.5.x 对齐 Spring Cloud 2025.0.x，Spring Cloud Alibaba 使用 2025.0.0.0 版本线。
